...
for line in open('C:/Users/Kleogis/Desktop/TXTstr/BZI1011010.txt'):
     ...
     if line.startswith ('BZIN1'):
         line.split()
         A01_BZIN1 = float(line[6:])
         
     if line.startswith ('BZIN2'):
         line.split()
         A01_BZIN2 = float(line[6:])
...
BZIN1_csh01 = ((A01_BZIN1*Ncal1+Ncal2)-BZIN1_exp)**2/NRMSE**2
BZIN2_csh01 = ((A01_BZIN2*Ncal1+Ncal2)-BZIN2_exp)**2/NRMSE**2

A01sum = PN_csh01 + C2_csh01 + pC2_csh01 + C3_csh01 + SBN_csh01 +CA_csh01 + pC_csh01 +CB_csh01 +UCO_csh01 + LCO_csh01 + Lys87N_csh01 + BZIN1_csh01 + BZIN2_csh01
A01X2 = float(A01sum / 13)
print ("A01 X^2:", A01X2)
...
#print BZIN1_csh01
#print BZIN2_csh01
for line in open ('C:/Users/Kleogis/Desktop/TXTstr/BZI1001110.txt'):
     if line.startswith ('PN'):
         line.split()
         A10_PN = float(line[3:])
     ...
     if line.startswith ('BZIN1'):
         line.split()
         A10_BZIN1 = float(line[6:])
         
     if line.startswith ('BZIN2'):
         line.split()
         A10_BZIN2 = float(line[6:])
...
BZIN1_csh10 = ((A10_BZIN1*Ncal1+Ncal2)-BZIN1_exp)**2/NRMSE**2
BZIN2_csh10 = ((A10_BZIN2*Ncal1+Ncal2)-BZIN2_exp)**2/NRMSE**2

A10sum = PN_csh10 + C2_csh10 + pC2_csh10 + C3_csh10 + SBN_csh10 +CA_csh10 + pC_csh10 +CB_csh10 +UCO_csh10 + LCO_csh10 + Lys87N_csh10 + BZIN1_csh10 + BZIN2_csh10
A10X2 = float(A10sum / 13)
print ("A10 X^2:", A10X2)
# Mixing X^2
Reg_coef = 0
i = 0.0001
...
#Reg_coef=Reg_coef + i
    ...
    BZIN1_csh_mix = (((A01_BZIN1*Ncal1+Ncal2)*Reg_coef+(1-Reg_coef)*(A10_BZIN1*Ncal1+Ncal2))-BZIN1_exp)**2/NRMSE**2
    BZIN2_csh_mix = (((A01_BZIN2*Ncal1+Ncal2)*Reg_coef+(1-Reg_coef)*(A10_BZIN2*Ncal1+Ncal2))-BZIN2_exp)**2/NRMSE**2
    Mix_sum = PN_csh_mix + C2_csh_mix + pC2_csh_mix + C3_csh_mix + SBN_csh_mix +CA_csh_mix + pC_csh_mix +CB_csh_mix +UCO_csh_mix + LCO_csh_mix + Lys87N_csh_mix + BZIN1_csh_mix + BZIN2_csh_mix
    Chi_mix_first = float(Mix_sum / 13)
